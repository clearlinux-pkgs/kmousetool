...
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/kmousetool-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/kmousetool-19.12.2.tar.xz.sig
...
%prep
%setup -q -n kmousetool-19.12.2
cd %{_builddir}/kmousetool-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581026797
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmousetool-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kmousetool/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/kmousetool-19.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmousetool/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
