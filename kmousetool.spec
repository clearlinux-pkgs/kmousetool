...
Requires: kmousetool-bin
Requires: kmousetool-data
Requires: kmousetool-license
Requires: kmousetool-locales
Requires: kmousetool-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1535199770
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1535199770
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/kmousetool
cp COPYING %{buildroot}/usr/share/doc/kmousetool/COPYING
cp COPYING.DOC %{buildroot}/usr/share/doc/kmousetool/COPYING.DOC
pushd clr-build
%make_install
popd
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/kmousetool/COPYING
/usr/share/doc/kmousetool/COPYING.DOC
