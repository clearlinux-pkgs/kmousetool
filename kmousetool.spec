...
Version  : 21.04.0
Release  : 29
URL      : https://download.kde.org/stable/release-service/21.04.0/src/kmousetool-21.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.04.0/src/kmousetool-21.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.0/src/kmousetool-21.04.0.tar.xz.sig
...
%prep
%setup -q -n kmousetool-21.04.0
cd %{_builddir}/kmousetool-21.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619219649
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmousetool-21.04.0/COPYING %{buildroot}/usr/share/package-licenses/kmousetool/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/kmousetool-21.04.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmousetool/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
