...
Version  : 21.12.0
Release  : 35
URL      : https://download.kde.org/stable/release-service/21.12.0/src/kmousetool-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kmousetool-21.12.0.tar.xz
...
%prep
%setup -q -n kmousetool-21.12.0
cd %{_builddir}/kmousetool-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639622926
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmousetool-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kmousetool/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kmousetool-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmousetool/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/kmousetool-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmousetool/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
