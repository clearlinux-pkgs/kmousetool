...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/kmousetool-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/kmousetool-24.12.1.tar.xz.sig
...
%setup -q -n kmousetool-24.12.1
cd %{_builddir}/kmousetool-24.12.1
pushd ..
cp -a kmousetool-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736532019
mkdir -p clr-build
pushd clr-build
...
/usr/share/man/sl/man1/kmousetool.1
