...
Version  : 20.12.1
Release  : 27
URL      : https://download.kde.org/stable/release-service/20.12.1/src/kmousetool-20.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/kmousetool-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/kmousetool-20.12.1.tar.xz.sig
...
%prep
%setup -q -n kmousetool-20.12.1
cd %{_builddir}/kmousetool-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610043671
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmousetool-20.12.1/COPYING %{buildroot}/usr/share/package-licenses/kmousetool/133efad5329acf364135c569ac01ec084c3d4647
cp %{_builddir}/kmousetool-20.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kmousetool/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
